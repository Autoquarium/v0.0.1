...
public:
  ...
  void updateDynamicColor(int current_time) {
...
void loop() {
arr.colorTransition(night, sunrise, 500);
arr.colorTransition(sunrise, day, 500);
delay(1000);

arr.colorTransition(day, sunset, 500);
arr.colorTransition(sunset, night, 500);
delay(1000);
}
